...
def can_be_found_updated_and_saved
  ...
  mv = Movie.find_by title: "Awesome Flick"
  mv.title = "Even Awesomer Flick"
  mv.save
end
...
def can_update_using_update_method
  ...
  mv = Movie.find_by(title: "Wat?")
  mv.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  mv = Movie.find_by title: "That One Where the Guy Kicks Another Guy Once"
  mv.destroy
end
